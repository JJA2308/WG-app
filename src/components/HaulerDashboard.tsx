    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 px-6 py-4 overflow-y-auto">
        ...
        <div className="text-center mb-6">
          <h2>Welcome to your Hauler Dashboard</h2>
            ...
            <Card 
              ...
              onClick={() => {
                if (item.title === "Messages" && onNavigate) {
                  onNavigate("messages");
                } else if (item.title === "Pending Proposals" && onNavigate) {
                  onNavigate("proposals");
                } else if (item.title === "Quote Requests" && onNavigate) {
                  onNavigate("quote-requests");
